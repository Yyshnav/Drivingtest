...
class _MyprofileState extends State<Myprofile> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: c1,  
     body: 
      Column(
        children: [
          Padding(
      ...
      child:Padding(
        ...
        child: Column(
          children: [
            ...
            child: 
            CircleAvatar(radius: 55,backgroundColor: const Color.fromARGB(255, 233, 206, 206),backgroundImage: NetworkImage('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTpCKq1XnPYYDaUIlwlsvmLPZ-9-rdK28RToA&usqp=CAU'),),),
            h20,
              Row(
        children: [
          Expanded(
